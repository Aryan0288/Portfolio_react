            ...
            <div id="wrapper">
                <div class="container">
                    <div class="navbar">
                        <div class="logo-container">
                            {/* <img src="imges/images_A.jpg" class="logo" alt="" /> */}
                            <img src="imges/remove_bg.png" class="logo" alt="" />
                    ...
                    <div class="hero-section">
                        ...
                        <div class="hero-section-right">
                            <div class="absolute icons icon-dots">
                                <img src="imges/dots.png" alt="" />
                            </div>
                            <div class="absolute icons icon-cube">
                                <img src="imges/cube.png" alt="" />
                            </div>
                            <div class="absolute icons icon-circle">
                                <img src="imges/circle.png" alt="" />
                            </div>
                            <div class="absolute icons icon-zigzak">
                                <img src="imges/zigzags.png" alt="" />
                            </div>
                            <div class="absolute icons icon-plus">
                                <img src="imges/plus.png" alt="" />
                            </div>
                            <div class="user-image">
                                <img src="imges/Aryan_img.png" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="project-card" id="project2">
                            ...
                            <div class="project-content project-content-right">
                                ...
                                <div class="project-skill-container">
                                    <img class="project-skill" src="imges/HTML.png" alt="" />
                                    <img class="project-skill" src="imges/CSS.png" alt="" />
                                    {/* <img class="project-skill" src="imges/javascript.png" alt="" /> */}
                                    <FontAwesomeIcon className='icon' icon={faJs} />
                                    <FontAwesomeIcon className='icon' icon={faReact} />
                                    <img class="project-skill" src="imges/Express.png" alt="" />
                                    <img class="project-skill" src="imges/Tailwind.png" alt="" />
                        ...
                        <div class="project-card" id="project3">
                            ...
                            <div class="project-content project-content-left">
                                ...
                                <div class="project-skill-container">
                                    ...
                                    <img class="project-skill" src="imges/NextJsCircle.png" alt="" />
                                    <img class="project-skill" src="imges/Tailwind.png" alt="" />
                                    {/* <!-- <img class="project-skill" src="https://codehelp-portfolio-website.netlify.app/images/stack/NodeJs.svg" alt=""> -->
                            <!-- <img class="project-skill" src="https://codehelp-portfolio-website.netlify.app/images/stack/MongoDB.svg" alt=""> -->
                ...
                <div class="skill-container container" id="skills">
                    ...
                    <div class="skill-container-right">
                        <img src="imges/blob vector.png" class="blob-style" alt="" />

                        <img src="imges/HTML.png" class="skill-logo" alt="" title="Html" />
                        <img src="imges/CSS.png" class="skill-logo" alt="" title="Css" />
                        <img src="https://codehelp-portfolio-website.netlify.app/images/stack/Javascript.svg" class="skill-logo"
                            alt="" title="JavaScript" />
                        <img src="imges/React.png" class="skill-logo" alt="" title="React" />
                        ...
                        <img src="https://codehelp-portfolio-website.netlify.app/images/stack/Redux.svg" class="skill-logo"
                            alt="" title="Redux" />
                        <img src="imges/Tailwind.png" class="skill-logo" alt="" title="Tailwind" />
                        <img src="imges/bootstrap.png" class="skill-logo" alt="" title="Bootstrap" />
                        <img src="imges/materialUi.png" class="skill-logo" alt="" title="materialUi" />
                        <img src="imges/Express.png" class="skill-logo" alt="" title="Express" />
                        <img src="imges/git.png" class="skill-logo" alt="" title="git" />
                        ...
                        <img src="https://codehelp-portfolio-website.netlify.app/images/stack/MongoDB.svg" class="skill-logo"
                            alt="" title="MongoDB" />
                        <img src="imges/vercel.jpg" class="skill-logo" alt="" title="Vercel" />
                        <img src="imges/Bash.png" class="skill-logo" alt="" title="Bash" />
                        <img src="https://codehelp-portfolio-website.netlify.app/images/stack/Docker.svg" class="skill-logo"
                            alt="" title="Docker" />
                        {/* <img src="imges/K8s.png" class="skill-logo" alt="" title="Html" /> */}
